...
function filterStudentsByGrade(students, grade) {
  ...
  filteredStudents.forEach((student) => {
    console.log(`name: ${student.name}, garde: ${student.grade}`);
  });
...
function validateUserInput(userInput) {
  if(!userInput.username) {
    colsole.log("Помилка: ім'я користувача відсутнє!");
  }

  if(!userInput.password) {
    colsole.log("Помилка: пароль відсутній!");
  }
...
function calculateTotalPrice(products) {
  ...
  console.log(`calculateTotalPrice: ${executionTime}ms`);
...
function countVowelsAndConsonants(word) {
  ...
  console.log(`Голосні літери: ${vowelsCount}`);
  console.log(`Приголосні літери: ${consonantsCount}`);
